...
Error: strict mode violation: getByText('紹介制') resolved to 2 elements:
    1) <span class="inline-flex items-center justify-center rounded-[var(--radius-seal)] border-[1.5px] border-shu bg-shu/10 px-1.5 py-0.5 font-display text-[10px] font-bold tracking-[0.14em] text-[#E8694F] ">紹介制</span> aka getByRole('link', { name: 'テスト店-1782226451466' })
    2) <p class="mt-1 text-xs text-txt-2">紹介制だけど一度行ってみたい</p> aka getByRole('link', { name: 'テスト店-1782226451466' })
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e21]:
      - banner [ref=e22]:
        ...
        - button "通知" [ref=e26]
        - link "shopper-1782226451466" [ref=e27] [cursor=pointer]:
          - /url: /me
          - generic [ref=e29]: s
      - main [ref=e30]:
        - generic [ref=e31]:
          ...
          - generic [ref=e35]:
            ...
            - link "テスト店-1782226451466 紹介制 紹介制だけど一度行ってみたい" [ref=e41] [cursor=pointer]:
              - /url: /shops/ea8837f0-c188-42e1-8090-b2ba2c075ca9
              - generic [ref=e42]:
                - generic [ref=e43]: 店
                - generic [ref=e44]:
                  - generic [ref=e45]:
                    - heading "テスト店-1782226451466" [level=3] [ref=e46]
                    - generic [ref=e47]: 紹介制
