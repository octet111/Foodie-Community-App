...
- banner:
  ...
  - button "通知"
  - link "mem-b-1782226371820":
    - /url: /me
    - text: m
- main:
  - link "‹ 企画一覧へ":
    - /url: /events
  - heading "精算企画-1782226371820" [level=1]
  - text: 募集中
  - paragraph:
    - text: 12/31（火）18:00（
    - link "精算店-1782226371820":
      - /url: /shops/3a26a749-da87-420f-90cc-19feaaaecb69
    - text: ↗）
  - text: 企画 org-stl-1782226371820 立替 未設定
  - paragraph: 参加表明済み
  - paragraph: 一次会に参加・締切前まで変更できます
  - link "精算へ":
    - /url: /events/577933fb-4bb4-4bf3-b534-d0b3eaa2e57a/settlement
    - button "精算へ"
