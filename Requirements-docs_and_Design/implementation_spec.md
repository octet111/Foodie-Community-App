...
7. **設定・仕上げ**: S10/S11、カレンダー表示、レスポンシブ調整 — **部分完成（2026-06-21）** §10 参照。**UIブラッシュアップ（2026-06-21）** §11 参照。**機能ブラッシュアップ（2026-06-21）** §12 参照。**機能ブラッシュアップ #3（2026-06-21）** §13 参照。残: Vercel デプロイ、全 AC E2E
